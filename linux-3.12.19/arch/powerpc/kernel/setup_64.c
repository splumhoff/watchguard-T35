...
void __init setup_arch(char **cmdline_p)
{
	...
	*cmdline_p = cmd_line;
	...
	/* reboot on panic */
#ifdef CONFIG_WG_PLATFORM_PANIC_TIMEOUT
	/* Provide a configurable timeout in init/Kconfig.wg */
	panic_timeout = CONFIG_WG_PLATFORM_PANIC_TIMEOUT;
#else
	panic_timeout = 180;
#endif /* CONFIG_WG_PLATFORM_PANIC_TIMEOUT */
